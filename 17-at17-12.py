...
def buildRules(ruleString):
    ...
    """
    # get rid of any spaces on the start and end of the ruleString()
...
def applyRuleSet(ruleSet, leftChar):
    """Write function applyRuleSet that takes a list of transformations( a rule set)
     ...
     Dude.  That's challenging!
    """

    # step through the ruleset and
    #  if I find the left char in the rule
    #   return the transformation

    # if I'm still running and didnt return
    # return the leftChar I started with
